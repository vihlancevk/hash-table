...
( Время выполнения программы в условных единицах - 16 540 686 )
### Ускорение функции strlen
Дальше мы можем ускорить функцию `strlen`.  
...
( Время выполнения программы в условных единицах - 15 243 681 )
## Итог
Общее ускорение составило примерно `68%`.
# Сборка программы
